...
{
    public class PercentageMonth6 : IPercentage
    {
        private readonly IRepository repository;
        private readonly string simbol;
        private readonly string interval;

        public PercentageMonth6(IRepository repository, string simbol, string interval)
        {
        ...
        {
            return this.GetPercentageChange(repository, simbol, KlineTimeframe.month1, interval, 6);
        }
    }
}
