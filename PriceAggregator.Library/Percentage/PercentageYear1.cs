...
{
    public class PercentageYear1 : IPercentage
    {
        private readonly IRepository repository;
        private readonly string simbol;
        private readonly string interval;

        public PercentageYear1(IRepository repository, string simbol, string interval)
        {
        ...
        {
            return this.GetPercentageChange(repository, simbol, KlineTimeframe.month1, interval, 12);
        }
    }
}
