...
{
    public class PercentageDay2 : IPercentage
    {
        private readonly IRepository repository;
        private readonly string simbol;
        private readonly string interval;

        public PercentageDay2(IRepository repository, string simbol, string interval)
        {
        ...
        {
            return this.GetPercentageChange(repository, simbol, KlineTimeframe.day1, interval, 2);
        }
    }
}
