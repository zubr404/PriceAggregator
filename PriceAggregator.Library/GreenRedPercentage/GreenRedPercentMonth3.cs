...
{
    public class GreenRedPercentMonth3 : IGreenRedPercent
	{
		private readonly IRepository repository;
		private readonly string simbol;
		private readonly string interval;

		public GreenRedPercentMonth3(IRepository repository, string simbol, string interval)
		{
		...
		{
			return this.GetGreenRedPercentChange(repository, simbol, KlineTimeframe.month1, interval, 3);
		}
	}
}
