...
{
    public class GreenRedPercentWeekly2 : IGreenRedPercent
	{
		private readonly IRepository repository;
		private readonly string simbol;
		private readonly string interval;

		public GreenRedPercentWeekly2(IRepository repository, string simbol, string interval)
		{
		...
		{
			return this.GetGreenRedPercentChange(repository, simbol, KlineTimeframe.weekly1, interval, 2);
		}
	}
}
