...
{
    public class GreenRedPercentHour3 : IGreenRedPercent
    {
        private readonly IRepository repository;
        private readonly string simbol;
        private readonly string interval;

        public GreenRedPercentHour3(IRepository repository, string simbol, string interval)
        {
        ...
        {
            return this.GetGreenRedPercentChange(repository, simbol, KlineTimeframe.hour1, interval, 3);
        }
    }
}
