...
{
    public class GreenRedPercentMonth2 : IGreenRedPercent
	{
		private readonly IRepository repository;
		private readonly string simbol;
		private readonly string interval;

		public GreenRedPercentMonth2(IRepository repository, string simbol, string interval)
		{
		...
		{
			return this.GetGreenRedPercentChange(repository, simbol, KlineTimeframe.month1, interval, 2);
		}
	}
}
